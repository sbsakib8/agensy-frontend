                    ...
                    >
                      <div className="bg-slate-800/95 backdrop-blur-xl rounded-xl shadow-2xl border border-slate-700/50 overflow-hidden animate-fade-in">
                        ...
                        <div className="px-4 py-3 border-b border-slate-700/50">
                          <div className="font-medium text-white">{user.name || user.firstName || 'User'}</div>
                          ...
                          >
                            <div className="flex items-center justify-between w-full">
                              <div className="flex items-center">
                                ...
                                <div>
                                  <h3 className="text-white font-medium group-hover:text-cyan-400 transition-colors">Track Order</h3>
                                </div>
                              </div>
                              <ArrowRight className="w-4 h-4 text-cyan-400 opacity-0 -translate-x-2 group-hover:opacity-100 group-hover:translate-x-0 transition-all duration-300" />
                            </div>
                          ...
                          >
                            <div className="flex items-center justify-between w-full">
                              <div className="flex items-center">
                                ...
                                <div>
                                  <h3 className="text-white font-medium group-hover:text-cyan-400 transition-colors">Profile</h3>
                                </div>
                              </div>
                              <ArrowRight className="w-4 h-4 text-cyan-400 opacity-0 -translate-x-2 group-hover:opacity-100 group-hover:translate-x-0 transition-all duration-300" />
                            </div>
